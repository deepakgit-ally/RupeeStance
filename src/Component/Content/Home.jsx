...
import Backimges from "../../Assets/Images/rupeeback.jpg"
function Home() {
  return (
    <>
    <div className=" landing-pagebg-light">
    <div className=" bg-light">
      <div>
        <img src={Backimges} alt="" srcset="" className=" position-absolute img-fluid w-100 h-50"style={{
        
        
        }} />
      </div>
        <div className=" p-1 m-1 mt-0 position-relative">
